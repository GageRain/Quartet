...
if __name__ == '__main__':
    # import data
    data = readcsv("./data/Quartet_data_tpcds.csv")
    label = readcsv("./data/Quartet_label_tpcds.csv")
    ...
    joblib.dump(min_max_scaler, 'tpcds_scaler.pkl')
    ...
    torch.save(model, "OC_tpcds_model.pkl")
    # store train_loss and test_loss
    writeCsv.writecsv("./data/OC_tpcds_train_loss.csv", np.array(py))
    writeCsv.writecsv("./data/OC_tpcds_test_loss.csv", np.array(pz))
    # store train_acc and test_acc
    writeCsv.writecsv("./data/OC_tpcds_train_acc.csv", np.array(py1))
    writeCsv.writecsv("./data/OC_tpcds_test_acc.csv", np.array(pz1))
    # drawing loss
    ...
    plt.savefig("./images/train_OC_tpcds.png")
